...
phopqind = x(42);  % inducible phoPQ %
    ...
    % nonlinear Mg %
kpdeg_eff = 3.1e-4;
%%%changed from 10 to 15 for kmdeg, ktlnA, and ktlnE
kmdeg =15^x(2);
ktlnA =15^x(3); 
ktlnE = 15^x(4); 
...
f2 = 10^x(21);
ktlnY = 10^-1.3;
%reduced exponent from 24 to 23 below
kb2 = 10^x(23); % binding SK*, X
%% changed 25 to 24 caused an interesting result but bad for other graphs
